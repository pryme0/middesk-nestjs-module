...
export type OrderProductType = 'bankruptcies' | 'business_verification_qualify' | 'business_verification_verify   ' | 'documents' | 'kyc' | 'kyc_doc_v' | 'tin' | 'litigations' | 'people_bankruptcies' | 'ucc_liens' | 'website' | 'tax_liens';
export type SubProductType = 'Articles of Incorporation' | 'Certificate of Good Standing' | 'ucc_documents' | 'liens';
export interface MiddeskOrdersInterface {
    product: OrderProductType;
}
export type EntityType = 'CORPORATION' | 'LLC' | 'PARTNERSHIP' | 'NON-PROFIT' | 'TRUST' | 'SOLE PROPRIETORSHIP';
...
export interface MiddeskAddressResponseInterface extends MiddeskAddressInterface {
    created_at: string;
    updated_at: string;
    latitude?: number;
    longitude?: number;
