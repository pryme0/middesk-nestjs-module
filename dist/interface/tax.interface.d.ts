import { MiddeskCompanyIndividualInterface, MiddeskCompanyAddressInterface } from './company.interface';
export type TaxRegistrationType = 'state_unemployment_insurance' | 'state_tax_withholdings';
